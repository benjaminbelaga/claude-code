function onOpen() {
  ...
  // --- Stock Update Menu (WEBMASTER v2.0) ---
  ...
  const otherUpdatesMenu = ui.createMenu('🔄 Other Updates');
  otherUpdatesMenu.addItem('🚀 Update Picking (Direct API)', 'updatePickingDirectAPI');
  otherUpdatesMenu.addItem('📅 Update Release Date YYD (Direct API)', 'updateReleaseDateDirectAPI');
  apiDirectMenu.addSubMenu(otherUpdatesMenu);
  ...
  yydAPIMenu.addItem('⚡ Create New Products (NEW YOYAKU API v2.3.0)', 'processYYDNewProductsAPI');
  ...
  // Import 852 - Create New Products via NEW REST API (⚠️ OLD LOCATION - use "New Product API" menu instead)
  const import852Menu = ui.createMenu('🚀 Create New Products (NEW REST API)');
  import852Menu.addItem('⚡ Create New Products (NEW REST API)', 'processImport852NewProductsAPI');
  import852Menu.addSeparator();
  import852Menu.addItem('⚡ Test Import API', 'testImport852API');
  ...
  import852Menu.addSeparator();
  import852Menu.addItem('📋 OLD Method: WP Import Instructions', 'showLegacyImport852Instructions');
  ...
  // Import 935 - Create New Products via NEW YOYAKU API v2.3.0 (⚠️ OLD LOCATION - use "New Product API" menu instead)
  const import935Menu = ui.createMenu('🚀 Create New Products (NEW YOYAKU API v2.3.0)');
  import935Menu.addItem('⚡ Create New Products (NEW YOYAKU API v2.3.0)', 'processYYDNewProductsAPI');
  import935Menu.addSeparator();
  import935Menu.addItem('⚡ Test Import API', 'testImport935API');
  ...
  import935Menu.addSeparator();
  import935Menu.addItem('📋 OLD Method: WP Import Instructions', 'showLegacyImport935Instructions');
